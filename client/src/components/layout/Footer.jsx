        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <div className="space-y-2 text-xs text-slate-400">
              ...
              <div className="pt-1 border-t border-slate-800 space-y-1">
                <p>✉️ <a href={`mailto:${CONTACT_INFO.emails[0].address}`} className="hover:text-amber-400 [overflow-wrap:anywhere] break-words">{CONTACT_INFO.emails[0].address}</a></p>
                <p>✉️ <a href={`mailto:${CONTACT_INFO.emails[1].address}`} className="hover:text-amber-400 [overflow-wrap:anywhere] break-words">{CONTACT_INFO.emails[1].address}</a></p>
              </div>
            </div>
          </div>
        </div>
